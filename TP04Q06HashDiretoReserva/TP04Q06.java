...
class HashDireta{
    ...
    HashDireta(int tamTab, int tamReserva){
        this.tamTab = tamTab;
...
class TP04Q06{
        static HashDireta arvore = new HashDireta();
        ...
        String arqLog = "625188\t" + Double.toString(HashDireta.tempoExec) + "\t" + Integer.toString(HashDireta.numComp);
        Arq.openWriteClose("625188_hashReserva.txt", "UTF-8", arqLog);
