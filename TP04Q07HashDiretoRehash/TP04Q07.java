...
class HashRehash{
    ...
    HashRehash(int tamTab, int tamReserva){
        this.tamTab = tamTab;
...
class TP04Q07{
        static HashRehash arvore = new HashRehash();
        ...
        String arqLog = "625188\t" + Double.toString(HashRehash.tempoExec) + "\t" + Integer.toString(HashRehash.numComp);
        Arq.openWriteClose("625188_hashRehash.txt", "UTF-8", arqLog);
